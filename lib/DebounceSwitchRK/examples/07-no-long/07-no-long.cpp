...
void setup() {
    ...
    // Disable long press and very long press modes
    DebounceSwitch::getInstance()->withNoLongPress();

    DebounceSwitch::getInstance()->addSwitch(D3, DebounceSwitchStyle::PRESS_LOW_PULLUP, 
