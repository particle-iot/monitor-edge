...
//
// Monitor One Specifc IO
//
#define MONITORONE_THERMISTOR                   (A3)
#define MONITORONE_USER_BUTTON                  (D2)

#define MONITORONE_STS3X_I2C_INSTANCE           (Wire)
#define MONITORONE_STS3X_I2C_ADDR               (0x4a)
