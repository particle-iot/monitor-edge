...
//***************** INCLUDES *********************
#include "Particle.h"
#include "edge_imu_abstraction.h"
...
//***************** GLOBALS **********************
EdgeImuAbstraction *EdgeImuAbstraction::_instance = nullptr;


//************ CLASS: EdgeImuAbstraction ************
EdgeImuAbstraction::EdgeImuAbstraction()
...
BmiVariant EdgeImuAbstraction::getImuType(void)
{
...
int EdgeImuAbstraction::begin(const TwoWire* interface, uint8_t address, pin_t interruptPin, size_t eventDepth)
{
...
int EdgeImuAbstraction::begin(const SPIClass& interface, pin_t selectPin, pin_t interruptPin, size_t eventDepth)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::syncEvent(BmiEventType event)
{
...
int EdgeImuAbstraction::waitOnEvent(BmiEventType& event, system_tick_t timeout)
{
...
int EdgeImuAbstraction::initAccelerometer(BmiAccelerometerConfig& config, bool feedback)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::getAccelerometer(BmiAccelerometer& data)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::getAccelerometerPmu(BmiPowerState& pmu)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::initMotion(BmiAccelMotionConfig& config, bool feedback)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::initHighG(BmiAccelHighGConfig& config, bool feedback)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::startMotionDetect()
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::stopMotionDetect()
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::startHighGDetect()
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int EdgeImuAbstraction::stopHighGDetect()
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
int  EdgeImuAbstraction::getStatus(uint32_t& val, bool clear)
{
    CHECK_TRUE(isInitialized_, SYSTEM_ERROR_INVALID_STATE);
...
bool EdgeImuAbstraction::isMotionDetect(uint32_t val)
{
...
bool EdgeImuAbstraction::isHighGDetect(uint32_t val)
{
    CHECK_TRUE(isInitialized_, false);
