...
EdgeFuelGauge *EdgeFuelGauge::_instance = nullptr;
...
void EdgeFuelGauge::verify_model()
{
...
void EdgeFuelGauge::enable_publish_pmic_regs(bool enable)
{
    publishPMICRegs = enable;
}


void EdgeFuelGauge::test()
{
