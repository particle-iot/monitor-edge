...
class EdgeLocationPublish {
public:
    static EdgeLocationPublish& instance() {
        static EdgeLocationPublish instance;
        return instance;
    }

    /**
     * @brief Initialize the EdgeLocationPublish object
     *
    ...
    EdgeLocationPublish(EdgeLocationPublish const&) = delete;
    void operator=(EdgeLocationPublish const&)  = delete;

private:
    EdgeLocationPublish() : store_msg_queue () {}
