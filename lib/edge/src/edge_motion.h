...
public:
     ...
     * @retval EdgeMotion&
     */
    static EdgeMotion &instance()
    {
        if(!_instance)
        {
            _instance = new EdgeMotion();
        }
        return *_instance;
    }
    ...
    /**
     * @brief Get EdgeMotion statistics
     *
     * @param stats Returned structure of EdgeMotion statistics
     */
...
private:
    ...
    EdgeMotion();
    static EdgeMotion *_instance;

    /**
     * @brief EdgeMotion main thread to receive, process, and send events
     *
     * @param context EdgeMotion instance pointer
     */
