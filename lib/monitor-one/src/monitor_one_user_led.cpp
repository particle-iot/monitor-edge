...
MonitorOneUserLed *MonitorOneUserLed::_instance   = nullptr;

int MonitorOneUserLed::init()
{
...
ADP8866_RGB &MonitorOneUserLed::get_rgb1_instance()
{
    return *pRGB1;
}

ADP8866_RGB &MonitorOneUserLed::get_rgb2_instance()
{
    return *pRGB2;
}