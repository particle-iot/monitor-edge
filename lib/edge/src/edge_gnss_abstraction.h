...
public:
     ...
     *
     */
    EdgeGnssConfiguration(EdgeGnssConfiguration&&) = default;
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& enableFastLock(bool enable) {
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& enableUDR(bool enable) {
        _enableUDR = enable;
        return *this;
    }
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& udrModel(ubx_dynamic_model_t model) {
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& enableIMUAutoAlignment(bool enable) {
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuOrientationAngles(double yaw, double pitch, double roll) {
        _imuYaw = yaw;
        _imuPitch = pitch;
        _imuRoll = roll;
        return *this;
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuYaw(double yaw) {
        _imuYaw = yaw;
        return *this;
    }
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuPitch(double pitch) {
        _imuPitch = pitch;
        return *this;
    }
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuRoll(double roll) {
        _imuRoll = roll;
        return *this;
    }
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuToVRP(int16_t x, int16_t y, int16_t z) {
        _imuVRPX = x;
        _imuVRPY = y;
        _imuVRPZ = z;
        return *this;
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuToVRPX(int16_t x) {
        _imuVRPX = x;
        return *this;
    }
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuToVRPY(int16_t y) {
        _imuVRPY = y;
        return *this;
    }
     ...
     * @return EdgeGnssConfiguration&
     */
    EdgeGnssConfiguration& imuToVRPZ(int16_t z) {
        _imuVRPZ = z;
        return *this;
    }
     ...
     *
     * @return EdgeGnssConfiguration& object
     */
    EdgeGnssConfiguration& enableHotStartOnWake(bool enable) {
     ...
     * @return EdgeGnssConfiguration& object
     */
    EdgeGnssConfiguration& enableAssistNowAutonomous(bool enable) {
        _enableAssistNowAutonomous = enable;
        return *this;
    }

    EdgeGnssConfiguration& operator=(const EdgeGnssConfiguration& rhs) {
        if (this == &rhs) {
            return *this;
        }
...
/**
 * @brief GNSS abstraction class to configure available GNSS modules.
 *
 */
class EdgeGnssAbstraction {
public:
    ...
    /**
     * @brief Return instance of the EdgeGnssAbstraction
     *
     * @retval EdgeGnssAbstraction&
     */
    static EdgeGnssAbstraction &instance()
    {
        if(!_instance)
        {
            _instance = new EdgeGnssAbstraction();
        }
        return *_instance;
    }
     ...
     */
    int begin(const EdgeGnssConfiguration& config);
...
private:
    ...
    EdgeGnssAbstraction();
    static EdgeGnssAbstraction *_instance;

    EdgeGnssConfiguration _deviceConfig;
     ...
     */
    bool configureGPS(EdgeGnssConfiguration& config);
